...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="/assets/backend/img/favicons/android-icon-192x192.png">
    ...
    <main class="main" id="top">
            ...
            <div class="container-medium">
                ...
                <div class="row g-3 position-relative">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-md-7">
                                <h4 class="fw-semibold mb-3">RSUD Kawali</h4>
                                <h2 class="fs-4 fw-semibold mb-3 mb-md-4">Your Health, Our Priority</h2>
                                <p class="mb-3 mb-md-0 text-body-tertiary">RSUD Kawali is committed to providing quality
                                    healthcare services to the community. We offer a wide range of medical services,
                                    including:</p>
                                <ul>
                                    ...
                                    <li>Specialized clinics (e.g., cardiology, neurology, pediatrics)</li>
                                </ul>
                            </div>
                            <div class="col-6 col-md-5">
                                <div class="img-zoom-hover position-relative h-100 rounded-3 overflow-hidden">
                                    <a href="#!"><img class="w-100 h-100 object-fit-cover"
                                            src="/assets/backend/img/rsud-kawali-building.jpg"
                                            alt="RSUD Kawali Building" /></a>
                                    <div class="backdrop-faded">
                                        <a class="fw-bold fs-7 text-white" href="#!">Our Facilities</a>
                                        <p class="mb-0 text-white fs-9">Modern and well-equipped</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 col-md-5">
                                <div class="img-zoom-hover position-relative h-100 rounded-3 overflow-hidden">
                                    <a href="#!"><img class="w-100 h-100 object-fit-cover"
                                            src="/assets/backend/img/medical-staff.jpg" alt="Medical Staff" /></a>
                                    <div class="backdrop-faded">
                                        <a class="fw-bold fs-7 text-white" href="#!">Dedicated Staff</a>
                                        <p class="mb-0 text-white fs-9">Caring for you</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="img-zoom-hover position-relative h-100 rounded-3 overflow-hidden">
                                    <a href="#!"><img class="w-100 h-md-100 object-fit-cover"
                                            src="/assets/backend/img/medical-technology.jpg" alt="Medical Technology"
                                            height="220" /></a>
                                    <div class="backdrop-faded">
                                        <a class="fw-bold fs-7 text-white" href="#!">Advanced Technology</a>
                                        <p class="mb-0 text-white fs-9">Improving patient care</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="d-flex flex-column gap-3 h-100">
                            <div class="img-zoom-hover position-relative h-100 rounded-3 overflow-hidden">
                                <a href="#!"><img class="w-100 h-lg-100 object-fit-cover"
                                        src="/assets/backend/img/hospital-environment.jpg" alt="Hospital Environment"
                                        height="220" /></a>
                                <div class="backdrop-faded">
                                    <a class="fw-bold fs-7 text-white" href="#!">Healing Environment</a>
                                    <p class="mb-0 text-white fs-9">Comfort and care</p>
                                </div>
                            </div>
                            <button class="btn btn-primary w-100 py-3 fs-8">Learn More<span
        ...
        <section class="pb-10 pt-0">
            ...
            <div class="container-medium text-center mb-11 position-relative">
                <h3 class="mb-2 text-body-emphasis">Explore RSUD Kawali</h3>
                <p class="text-body-tertiary mb-0">Discover the heart of Kawali's healthcare.</p>
            </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide w-sm-auto"><a
                                    class="position-relative rounded-3 overflow-hidden d-block" href="#!"><img
                                        ...
                                        src="/assets/backend/img/rsud_kawali/foto1.jpg" alt="" height="220" />
                                    <div class="img-backdrop-faded">
                                        <div class="image-reveal-content mb-3">
                                            <div class="d-flex align-items-center gap-2 mb-2"><span
                                                    class="fa-solid fa-hospital text-secondary-lighter"></span>
                                                <h6 class="mb-0 text-secondary-lighter fw-semibold">Pelayanan Unggul
                                                </h6>
                                            </div>
                                            <div class="d-flex align-items-center gap-2"><span
                                                    class="fa-solid fa-stethoscope text-secondary-lighter"></span>
                                                <h6 class="mb-0 text-secondary-lighter fw-semibold">Kesehatan Prima</h6>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center gap-2">
                                            <h4 class="mb-0 text-white">RSUD Kawali</h4>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="swiper-slide w-sm-auto"><a
                                    class="position-relative rounded-3 overflow-hidden d-block" href="#!"><img
                                        class="w-100 w-sm-auto object-fit-cover"
                                        src="/assets/backend/img/rsud_kawali/foto2.jpg" alt="" height="220" />
                                    <div class="img-backdrop-faded">
                                        <div class="image-reveal-content mb-3">
                                            <div class="d-flex align-items-center gap-2 mb-2"><span
                                                    class="fa-solid fa-bed-pulse text-secondary-lighter"></span>
                                                <h6 class="mb-0 text-secondary-lighter fw-semibold">Fasilitas Lengkap
                                                </h6>
                                            </div>
                                            <div class="d-flex align-items-center gap-2"><span
                                                    class="fa-solid fa-user-doctor text-secondary-lighter"></span>
                                                <h6 class="mb-0 text-secondary-lighter fw-semibold">Tenaga Medis
                                                    Profesional</h6>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center gap-2">
        ...
        <section>
            <div class="container-medium position-relative">
                <h3 class="mb-2 text-body-emphasis text-center text-xl-start">RSUD Kawali</h3>
                    ...
                    <div class="col-sm-11 col-md-8 col-lg-6 col-xl-12">
                        <div class="row gy-5 gx-xl-7 justify-content-between pe-4">
                            <div class="col-xl-4">
                                <div class="card card-img-shift border-0 mx-auto">
                                    <div class="rounded-3 overflow-hidden w-100 position-relative z-5"><img
                                            class="w-100" src="/assets/backend/img/gallery/rsud_kawali_1.jpg" alt=""
                                            height="250" />
                            ...
                            <div class="col-xl-4">
                                <div class="card card-img-shift border-0 mx-auto">
                                    <div class="rounded-3 overflow-hidden w-100 position-relative z-5"><img
                                            class="w-100" src="/assets/backend/img/gallery/rsud_kawali_2.jpg" alt=""
                                            height="250" />
                                        <button class="btn btn-wish position-absolute top-0 end-0 mt-3 me-3"><span
                                                class="far fa-heart"></span></button>
                                    </div>
                            ...
                            <div class="col-xl-4">
                                <div class="card card-img-shift border-0 mx-auto">
                                    <div class="rounded-3 overflow-hidden w-100 position-relative z-5"><img
                                            class="w-100" src="/assets/backend/img/gallery/rsud_kawali_3.jpg" alt=""
                                            height="250" />
                                        <button class="btn btn-wish position-absolute top-0 end-0 mt-3 me-3"><span
                                                class="far fa-heart"></span></button>
                                    </div>
        ...
        <section class="py-10 overflow-hidden">
            ...
            <div class="container-medium position-relative z-2">
                ...
                <ul class="nav mb-6 justify-content-center flex-wrap mx-auto w-max-content"
                    ...
                    <li class="nav-item"><a class="isotope-nav cursor-pointer active" data-filter=".tokyo">Tokyo</a>
                    </li>
                        ...
                        <div class="row gx-0 gy-3" id="image_gallery"
                            ...
                            <div class="col-12 isotope-item w-100 tokyo">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover" src="/assets/backend/img/gallery/tokyo-1.png"
                                            alt="" height="220" /></a>
                            ...
                            <div class="col-12 isotope-item w-100 tokyo">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover" src="/assets/backend/img/gallery/tokyo-2.png"
                                            alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                            ...
                            <div class="col-12 isotope-item w-100 tokyo">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover" src="/assets/backend/img/gallery/tokyo-3.png"
                                            alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                            ...
                            <div class="col-12 isotope-item w-100 bali">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover" src="/assets/backend/img/gallery/bali-1.png"
                                            alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                            ...
                            <div class="col-12 isotope-item w-100 bali">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover" src="/assets/backend/img/gallery/bali-2.png"
                                            alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                            ...
                            <div class="col-12 isotope-item w-100 bali">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover" src="/assets/backend/img/gallery/bali-3.png"
                                            alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                            ...
                            <div class="col-12 isotope-item w-100 sydney">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            ...
                                            src="/assets/backend/img/gallery/sydney-1.png" alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                                            href="#!">The
                            ...
                            <div class="col-12 isotope-item w-100 sydney">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover"
                                            src="/assets/backend/img/gallery/sydney-2.png" alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                                            href="#!">Manly
                            ...
                            <div class="col-12 isotope-item w-100 sydney">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover"
                                            src="/assets/backend/img/gallery/sydney-3.png" alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                            ...
                            <div class="col-12 isotope-item w-100 paris">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover" src="/assets/backend/img/gallery/paris-1.png"
                                            alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                            ...
                            <div class="col-12 isotope-item w-100 paris">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover" src="/assets/backend/img/gallery/paris-2.png"
                                            alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                            ...
                            <div class="col-12 isotope-item w-100 paris">
                                <div class="img-zoom-hover-lg rounded-2 overflow-hidden"><a href="#!"> <img
                                            class="w-100 object-fit-cover" src="/assets/backend/img/gallery/paris-3.png"
                                            alt="" height="220" /></a>
                                    <button class="btn btn-wish position-absolute top-0 end-0 mt-4 me-4"><span
                                            class="far fa-heart"></span></button>
                                    <div class="backdrop-faded"><a class="text-white fw-bolder fs-7 stretched-link"
                ...
                <div class="row g-0 justify-content-center">
                    <div class="col-lg-10 col-xl-7">
                        <div class="d-md-flex align-items-center gap-7 text-center text-md-start"><img
                                class="mb-4 mb-md-0 d-dark-none" src="/assets/backend/img/spot-illustrations/40.png"
                                width="260" alt="" /><img class="mb-4 mb-md-0 d-light-none"
                                src="/assets/backend/img/spot-illustrations/dark_40.png" width="260" alt="" />
                            <div class="flex-1">
                ...
                <div class="row g-3">
                    <div class="col-md-6 col-xl-4">
                        <div class="img-zoom-hover rounded-3 overflow-hidden position-relative"><a href="#!"><img
                                    class="latest-img w-100 object-fit-cover" src="/assets/backend/img/gallery/51.png"
                                    alt="" /></a>
                            <div class="backdrop-faded"><a
                                    class="fw-semibold mb-0 text-secondary-lighter stretched-link" href="#!"><span
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="img-zoom-hover rounded-3 overflow-hidden position-relative"><a href="#!"><img
                                    class="latest-img w-100 object-fit-cover" src="/assets/backend/img/gallery/52.png"
                                    alt="" /></a>
                            <div class="backdrop-faded"><a
                                    class="fw-semibold mb-0 text-secondary-lighter stretched-link" href="#!"><span
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="img-zoom-hover rounded-3 overflow-hidden position-relative"><a href="#!"><img
                                    class="latest-img w-100 object-fit-cover" src="/assets/backend/img/gallery/53.png"
                                    alt="" /></a>
                            <div class="backdrop-faded"><a
                                    class="fw-semibold mb-0 text-secondary-lighter stretched-link" href="#!"><span
                                        class="fa-solid fa-location-dot text-secondary-lighter me-2"></span>Bali
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="img-zoom-hover rounded-3 overflow-hidden position-relative"><a href="#!"><img
                                    class="latest-img w-100 object-fit-cover" src="/assets/backend/img/gallery/54.png"
                                    alt="" /></a>
                            <div class="backdrop-faded"><a
                                    class="fw-semibold mb-0 text-secondary-lighter stretched-link" href="#!"><span
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="img-zoom-hover rounded-3 overflow-hidden position-relative"><a href="#!"><img
                                    class="latest-img w-100 object-fit-cover" src="/assets/backend/img/gallery/55.png"
                                    alt="" /></a>
                            <div class="backdrop-faded"><a
                                    class="fw-semibold mb-0 text-secondary-lighter stretched-link" href="#!"><span
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="img-zoom-hover rounded-3 overflow-hidden position-relative"><a href="#!"><img
                                    class="latest-img w-100 object-fit-cover" src="/assets/backend/img/gallery/56.png"
                                    alt="" /></a>
                            <div class="backdrop-faded"><a
                                    class="fw-semibold mb-0 text-secondary-lighter stretched-link" href="#!"><span
                ...
                <div class="row g-0 justify-content-center">
                    <div class="col-lg-10 col-xl-8 col-xxl-7">
                        <div class="d-md-flex align-items-center gap-5 text-center text-md-start"><img
                                class="img-fluid d-dark-none" src="/assets/backend/img/spot-illustrations/i-phone.png"
                            ...
                            <div class="mt-5 mt-md-0">
                                <div class="d-none d-md-block"><img class="d-dark-none"
                                        src="/assets/backend/img/spot-illustrations/41.png" alt="" width="200" /><img
                                        class="d-light-none" src="/assets/backend/img/spot-illustrations/dark_41.png"
                                        alt="" width="200" /></div>
                                ...
                                <p class="text-body-tertiary">Designed to provide the best user experience possible
                                    ...
                                    unthinkables.</p><a class="me-2" href="#!"><img
                                        src="/assets/backend/img/generic/play-store.png" alt="" height="32" /></a><a
                                    href="#!"><img src="/assets/backend/img/generic/app-store.png" alt=""
                                        height="32" /></a>
                            </div>
                        </div>
                    </div>
        ...
        <section class="booking-footer pb-6 pb-md-11 pt-15">
            ...
            <div class="container-medium">
                <div class="row gy-3 justify-content-between align-items-center">
                    <div class="col-auto"><a href="#!"><img src="/assets/backend/img/icons/logo-1.png" alt="" /></a>
                    </div>
                    <div class="col-auto">
